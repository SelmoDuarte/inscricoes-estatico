...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  "./src/app/areaParticipante/areaParticipante.component.ts": function srcAppAreaParticipanteAreaParticipanteComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_services_dropdown_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../shared/services/dropdown.service */
    "./src/app/shared/services/dropdown.service.ts");
    /* harmony import */


    var _shared_services_consulta_cep_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../shared/services/consulta-cep.service */
    "./src/app/shared/services/consulta-cep.service.ts");
    /* harmony import */


    var _shared_form_validation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../shared/form-validation */
    "./src/app/shared/form-validation.ts");
    /* harmony import */


    var _areaParticipante_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var _login_usuario__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../login/usuario */
    ...
    var _modal_acessoNegado_modal_acessoNegado_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../modal-acessoNegado/modal-acessoNegado.component */
    "./src/app/modal-acessoNegado/modal-acessoNegado.component.ts");
    /* harmony import */


    var _usuario_usuario_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    var AreaParticipanteComponent = /*#__PURE__*/function () {
      ...
      _createClass(AreaParticipanteComponent, [{
        ...
        value: function getTimeDifference() {
          ...
          this.allocateTimeUnits(this.timeDifference); // Inicializamos o objeto Date() com data e horário atual

          var date1 = new Date(); // APRESENTACAO DE TRABALHOS CIENTIFICOS 

          var date2 = new Date('2021-09-16 08:00:00');
          var date3 = new Date('2021-09-16 18:00:00');
          ...
          var date4 = new Date('2021-09-17 09:00:00');
          var date5 = new Date('2021-09-17 12:00:00');
          ...
          var date6 = new Date('2021-09-17 14:00:00');
          var date7 = new Date('2021-09-17 18:00:00');
          ...
          var date8 = new Date('2021-09-17 19:00:00');
          var date9 = new Date('2021-09-17 22:00:00');
        ...
        value: function ngOnInit() {
          ...
          this.subscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(1000).subscribe(function (x) {
          ...
          this.service.getMeusEventos().subscribe(function (response) {
            ...
            _this.listaAcessoPalestra = response.acessos_palestras;

            _this.verificarAcessoPalestras();
          }, function (err) {
            _this.carregando = false;
          ...
          var iframeAoVivo = document.getElementById('iframeAoVivo');
        }
      }, {
        key: "close",
        ...
        key: "acessoStreaming",
        value: function acessoStreaming(id) {
          var _this5 = this;
          ...
          if (id == "99") {
            /*ONLINE */
            alert("PARABÉNS, sua presença para esta palestra  \n foi registrada com sucesso !!!"); //    window.open("https://www.youtube.com/watch?v=Jm5UgWO4cFU",'_blank');
          ...
          this.service.registrarVisualizacaoVideo(id).subscribe(function (resp) {
            _this5.listaAcessoPalestra = resp.dados;

            _this5.verificarAcessoPalestras();
          });
        }
      }, {
        key: "verificarAcessoPalestras",
        value: function verificarAcessoPalestras() {
          var a;
          this.assistiuEvento1 = 0;
          this.assistiuEvento2 = 0;

          var _iterator = _createForOfIteratorHelper(this.listaMeusEventos),
              _step;
          ...
          var _iterator2 = _createForOfIteratorHelper(this.listaAcessoPalestra),
              _step2;
          ...
          var campo01 = document.getElementById('progressBarPainel01');
          campo01.style.width = this.assistiuEvento1 + '%';
          var campo02 = document.getElementById('progressBarPainel02');
          campo02.style.width = this.assistiuEvento2 + '%';
        }
      }, {
        key: "certificado",
        value: function certificado() {
          // Inicializamos o objeto Date() com data e horário atual
          var date1 = new Date(); // Inicializamos uma data no passado

          var date2 = new Date('2021-09-18 16:00:00');
        ...
        key: "fichaAvaliacao",
        value: function fichaAvaliacao() {
          // Inicializamos o objeto Date() com data e horário atual
          var date1 = new Date(); // Inicializamos uma data no passado

          var date2 = new Date('2021-09-18 14:00:00'); // Inicializamos uma data no passado

          var date3 = new Date('2021-09-30 01:00:00');
        ...
        value: function quiz() {
          ...
          var date2 = new Date('2021-09-18 09:00:00'); // Inicializamos uma data no passado

          var date3 = new Date('2021-09-18 14:30:00');
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _shared_services_dropdown_service__WEBPACK_IMPORTED_MODULE_5__["DropdownService"], _login_auth_service__WEBPACK_IMPORTED_MODULE_9__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_10__["Router"], _shared_services_consulta_cep_service__WEBPACK_IMPORTED_MODULE_6__["ConsultaCepService"], _areaParticipante_service__WEBPACK_IMPORTED_MODULE_8__["AreaParticipanteService"], _usuario_usuario_service__WEBPACK_IMPORTED_MODULE_14__["UsuarioService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_12__["NgbModal"]])], AreaParticipanteComponent);
    /***/
  },
  ...
  "./src/app/areaParticipante/areaParticipante.service.ts": function srcAppAreaParticipanteAreaParticipanteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AreaParticipanteService = /*#__PURE__*/function () {
      function AreaParticipanteService(http) {
        ...
        this.API_REGISTRAR_VISUALIZACAO_VIDEO = "".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].API, "inscricoes/registrarVisualizacaoVideo.php");
        this.httpOptions = {
      ...
      _createClass(AreaParticipanteService, [{
        ...
        key: "registrarVisualizacaoVideo",
        value: function registrarVisualizacaoVideo(id_video) {
          var jsonUsuario = JSON.parse(localStorage.getItem("usuario"));
          return this.http.post(this.API_REGISTRAR_VISUALIZACAO_VIDEO, {
            cpf: jsonUsuario.cpf,
            id: id_video
          }, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(console.log));
        }
      ...
      _createClass(HeaderComponent, [{
        ...
        value: function alterarSenha(content) {
          ...
          modal.result.then(function () {
            ...
            if (_this6.usuario.password_anterior == "") {
              _this6.alerts = Array.from([{
                type: 'danger',
                message: 'Senha atual inválida'
              }]);

              _this6.alterarSenha(content);

              return;
            }

            if (_this6.usuario.password == "" || _this6.usuario.password != _this6.usuario.password_conferir) {
              _this6.alerts = Array.from([{
                type: 'danger',
            ...
            _this6.authService.alterarSenha(_this6.usuario).subscribe(function (dados) {
              if (dados.status.codigo == 99) {
                _this6.alerts = Array.from([{
                  type: 'danger',
                  message: dados.status.mensagem
                ...
                _this6.usuario.password = "";
                _this6.usuario.password_anterior = "";
                _this6.usuario.password_conferir = "";
                console.log("Senha alterada com sucesso");
                alert('Senha alterada com sucesso !!!');
              }
            });
      ...
      _createClass(InscricoesComponent, [{
        ...
        value: function ngAfterViewInit() {
          ...
          this.dropdownService.getCidades(this.form.get('uf').value).subscribe(function (dados) {
            _this7.cidades = dados;

            _this7.cepService.consultaCEP(_this7.form.get('cep').value).subscribe(function (dados) {
              _this7.populaDadosForm(dados);
            });
          });
        }
      }, {
        ...
        value: function ngOnInit() {
          ...
          this.subscription = this.service.getEventos().subscribe(function (response) {
            ...
            if (response.status.codigo == 0) {
              _this8.lista = response.dados;
              _this8.listaOriginal = response.dados;
            } else {
              _this8.lista = [];
              _this8.listaOriginal = [];
          ...
          this.dropdownService.getPaises().subscribe(function (dados) {
            ...
            _this8.dropdownService.getEstadosBr().subscribe(function (dados) {
              _this8.estados = dados;
              _this8.carregando = false;
            });
          });
          this.form.get('uf').valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (uf) {
            ...
            return _this8.estados.filter(function (e) {
              return e.sigla === uf;
            });
          ...
          this.form.get('cep').statusChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (value) {
            ...
            return status === 'VALID' ? _this8.cepService.consultaCEP(_this8.form.get('cep').value) : Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["empty"])();
          })).subscribe(function (dados) {
            return dados ? _this8.populaDadosForm(dados) : {};
          });
        }
      }, {
        key: "getCupom",
        value: function getCupom() {
          ...
          this.subscription = this.service.getCupom(campoCupom.value).subscribe(function (response) {
            ...
            if (response.status.codigo == 0) {
              _this9.valorCupom = Number(response.dados.valor).toFixed(2);
              ;
              _this9.cupomValido = true;

              _this9.calcularValor();
            } else {
              _this9.valorCupom = 0;
              _this9.cupomValido = false;
        ...
        value: function calcularValor() {
          ...
          var _iterator3 = _createForOfIteratorHelper(this.lista),
              _step3;
        ...
        value: function descontoInscritosCONAD() {
          ...
          if (campo.checked) {
            ...
            var _iterator4 = _createForOfIteratorHelper(this.listaOriginal),
                _step4;
            ...
            var _iterator5 = _createForOfIteratorHelper(this.listaOriginal),
                _step5;
        ...
        value: function checkOut() {
          ...
          if (jsonUsuario.id_wirecard.length <= 0) {
            ...
            this.subscription = this.serviceWireCard.addClienteForm(this.form).subscribe(function (response) {
              ...
              _this10.service.atualizarID_Wirecard(response.id).subscribe();

              _this10.efetuarPagamento(response.id);
            }, function (err) {
              var ownId = _this10.form.get('cpf').value + Math.floor(Math.random() * (0 - 99 + 1));
              _this10.subscription = _this10.serviceWireCard.addCliente(ownId, _this10.form).subscribe(function (response) {
                console.log("Status" + response.id); //ATUALIZA O ID_WIRECARD NA TABELA DE PESSOAS
        ...
        value: function efetuarPagamento(id_cliente) {
          ...
          this.subscription = this.serviceWireCard.addPedido(id_cliente, this.form, this.valorCupom, this.listaCarrinho).subscribe(function (response) {
            ...
            if (campoCartao.checked) {
              _this11.pagamento.tipo = "C";

              _this11.efetuarPagamentoCartao(response.id);
            } else {
              _this11.pagamento.tipo = "B"; // PAGAMENTO PELO BOLETO

              _this11.efetuarPagamentoBoleto(response.id);
            }

            ;
          }, function (err) {
            _this11.habilitarCampos();

            _this11.carregando = false;
            _this11.pagamento.processado = false;
            _this11.alerts = Array.from([{
              type: 'danger',
              message: err.error.errors[0].description
            }]);
            console.log(err);
        ...
        value: function efetuarPagamentoCartao(id_pedido) {
          ...
          moip_sdk_js__WEBPACK_IMPORTED_MODULE_13__["MoipCreditCard"].setEncrypter(jsencrypt__WEBPACK_IMPORTED_MODULE_12__["default"], 'ionic').setPubKey(pubKey).setCreditCard({
            ...
            _this12.subscription = _this12.serviceWireCard.addPagamentoCartao(id_pedido, _this12.form, hash).subscribe(function (response) {
              if (response.status == 'CANCELLED') {
                _this12.pagamento.confirmado = false;
                _this12.carregando = false;
                _this12.pagamento.erro = true;
                _this12.pagamento.erroTipo = response.status;
        ...
        value: function efetuarPagamentoBoleto(id_pedido) {
          ...
          this.subscription = this.serviceWireCard.addPagamentoBoleto(id_pedido, this.form).subscribe(function (response) {
            _this13.pagamento.confirmado = true;
            _this13.carregando = false; //ATUALIZA A TABELA DE EVENTOS INSCRITOS

            _this13.service.inscricao(response.id, response.status, _this13.listaCarrinho, _this13.form.get('cupom').value).subscribe();

            _this13.pagamento.url = response._links.payBoleto.printHref;
            var dt = response.fundingInstrument.boleto.expirationDate;
            var data = dt.substring(8, 10) + "/" + dt.substring(5, 7) + "/" + dt.substring(0, 4);
            _this13.pagamento.dataVencimento = data;
            _this13.pagamento.codigoBarras = response.fundingInstrument.boleto.lineCode;
            _this13.pagamento.valor = Number(response.amount.total / 100).toFixed(2);
          }, function (erroResponse) {
            _this13.carregando = false;
            _this13.pagamento.erro = true;
            _this13.pagamento.alerts = Array.from([{
              type: 'danger',
              message: erroResponse.error.errors[0].description
            }]);
          });
    ...
    var InscricoesService = /*#__PURE__*/function () {
      ...
      _createClass(InscricoesService, [{
        ...
        value: function inscricao(id, status_wirecard, lista, id_cupom) {
          ...
          var _iterator6 = _createForOfIteratorHelper(lista),
              _step6;
    ...
    var WireCardService = /*#__PURE__*/function () {
      ...
      _createClass(WireCardService, [{
        ...
        value: function addPedido(id_wirecard, form, valorCupom, listaProdutos) {
          ...
          var _iterator7 = _createForOfIteratorHelper(listaProdutos),
              _step7;
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login() {
          ...
          this.authService.login(this.usuario).subscribe(function (resp) {
            if (resp.status.codigo == 99) {
              ...
              _this14.usuario.password = "";
              localStorage.setItem("usuario", JSON.stringify(resp.dados));
              console.log("USUARIO AUTENTICADO");

              _this14.router.navigate(['/areaParticipante']); //        this.carregando = false;
        ...
        value: function validarCPF() {
          ...
          this.authService.validarCPF(this.usuario).subscribe(function (dados) {
            if (dados.status.codigo == 99) {
              localStorage.removeItem("usuario");
              localStorage.setItem("cpf", _this15.usuario.login);
              _this15.carregando = false;

              _this15.router.navigate(['/usuario']);
            } else {
              _this15.carregando = false;
              _this15.cpfNaoCadastrado = false;
        ...
        value: function recuperarSenha() {
          ...
          this.authService.recuperarSenha(this.usuario).subscribe(function (dados) {
            if (dados.status.codigo == 99) {
              _this16.alerts = Array.from([{
                type: 'danger',
                message: dados.status.mensagem
              }]);
              localStorage.removeItem("usuario");
              _this16.carregando = false;
            } else {
              _this16.alerts = Array.from([{
                type: 'success',
                message: dados.status.mensagem
      ...
      _createClass(MaskDirective, [{
        ...
        value: function _repeatPatternSymbols(maskExp) {
          ...
          return maskExp.match(/{[0-9]+}/) && maskExp.split('').reduce(function (accum, currval, index) {
            _this17._start = currval === '{' ? index : _this17._start;

            if (currval !== '}') {
              return _this17._maskService._findSpecialChar(currval) ? accum + currval : accum;
            }

            _this17._end = index;
            var repeatNumber = Number(maskExp.slice(_this17._start + 1, _this17._end));
            var repaceWith = new Array(repeatNumber + 1).join(maskExp[_this17._start - 1]);
  ...
  "./src/app/shared/ngx-mask/mask.service.ts": function srcAppSharedNgxMaskMaskServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MaskService = /*#__PURE__*/function (_mask_applier_service) {
      ...
      document, _config, _elementRef, _renderer) {
        ...
        _this18.showMaskTyped = false;
        _this18.maskIsShown = ''; // tslint:disable-next-line

        _this18.onChange = function (_) {};

        _this18.onTouch = function () {};

        _this18._formElement = _this18._elementRef.nativeElement;
        return _this18;
      }
    ...
    var UsuarioComponent = /*#__PURE__*/function () {
      ...
      _createClass(UsuarioComponent, [{
        ...
        value: function ngAfterViewInit() {
          ...
          var campoCep = document.getElementById('cep');
          this.dropdownService.getCidades(this.form.get('uf').value).subscribe(function (dados) {
            _this19.cidades = dados;

            _this19.cepService.consultaCEP(_this19.form.get('cep').value).subscribe(function (dados) {
              _this19.populaDadosForm(dados);
            });
          });
        }
      }, {
        ...
        value: function ngOnInit() {
          ...
          this.dropdownService.getPaises().subscribe(function (dados) {
            _this20.paises = dados;

            _this20.dropdownService.getEstadosBr().subscribe(function (dados) {
              _this20.estados = dados;
          ...
          this.form.get('uf').valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (uf) {
            ...
            return _this20.estados.filter(function (e) {
              return e.sigla === uf;
            });
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (estados) {
            return estados && estados.length > 0 ? estados[0].id : Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["empty"])();
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (estadoId) {
            return _this20.dropdownService.getCidades(estadoId);
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(console.log)).subscribe(function (cidades) {
            return _this20.cidades = cidades;
          });
          this.form.get('cep').statusChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (value) {
            return console.log('status CEP:', value);
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (status) {
            return status === 'VALID' ? _this20.cepService.consultaCEP(_this20.form.get('cep').value) : Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["empty"])();
          })).subscribe(function (dados) {
            return dados ? _this20.populaDadosForm(dados) : {};
          });
        }
      }, {
        key: "populaDadosForm",
        ...
        value: function salvar() {
          ...
          this.service.salvar(this.form).subscribe(function (response) {
            ...
            if (response.status.codigo == 0) {
              ...
              _this21.form.disabled;
              _this21.alerts = Array.from([{
                type: 'success',
                message: response.status.mensagem
              }]);
            } else {
  ...
  0: function _(module, exports, __webpack_require__) {
    ...
    /*! D:\CONAD\Projetos\inscricoes-estatico\admin\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
